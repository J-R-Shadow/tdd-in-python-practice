...
print("Task 1!")
# Exercise
    # Loop through and print out all even numbers in order recieved.
    # Don't print any after 237 in the sequence.

numbers = [
    951, 402, 984, 651, 360, 69, 408, 319, 601, 485, 980, 507, 725, 547, 544, 615, 
    83, 165, 141, 501, 263, 617, 865, 575, 219, 390, 984, 592, 236, 105, 942, 345,
